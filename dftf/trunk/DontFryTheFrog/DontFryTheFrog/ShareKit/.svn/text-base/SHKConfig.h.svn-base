...
#define SHKFacebookAppID      @"158231894275259"
 ...
 */
#define SHKTwitterConsumerKey		@"XfAEXus5U8sPrCECsBWoA"
#define SHKTwitterSecret			@"QSZiXOHefDqPIuG1yCELVoDlJ1b4O1RKA8bkz4vXM"
#define SHKTwitterCallbackUrl		@"http://dontfrythefrog.com/twitter_callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
