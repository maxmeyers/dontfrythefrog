...
- (id) initWithHopshopLayer:(BTHopshopLayer *)hopshop {
    ...
    if (self){
        ...
        CCSprite *title = [CCSprite spriteWithSpriteFrameName:@"select-fly-title.png"];
...
- (void) setDisplayedLevel:(int) level {
    ...
    NSArray *levels = [[[[upgradeSelectLayer_ hopshopLayer] hopshopDetails] bugUpgrades] objectForKey:[bugClass_ description]];
