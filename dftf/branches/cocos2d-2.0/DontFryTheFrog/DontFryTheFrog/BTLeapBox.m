...
- (id) initWithLeap:(BTLeap *) leap AtIndex:(int) index WithPosition:(CGPoint) position {
    ...
    if (self){
        ...
        CCSprite *background = [CCSprite spriteWithFile:@"missionpanel.png"];
        ...
        CCSprite *badge = [CCSprite spriteWithFile:[NSString stringWithFormat:@"%@levelingbadge.png", badgeColor]];
        ...
        if (leap_){
            ...
            for (int i = 0; i < MIN(6, [leap_ reward]); i++){
                ...
                CCSprite *lilyPad = [CCSprite spriteWithFile:@"lillypad.png"];
